...
/*! @name PIO1_9 (number 10), S3/P18[1]/PIO1_9_GPIO_ARD
  @{ */
#define BOARD_INTPIN_S3_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INTPIN_S3_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INTPIN_S3_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                 /* @} */
 ...
 *
 */
void BOARD_IntPin(void); /* Function assigned for the Cortex-M33 (Core #0) */
